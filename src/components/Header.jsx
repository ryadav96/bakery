      ...
      {isDrawerOpen && (
        <div className="fixed top-0 right-0 bottom-0 w-1/2 bg-white z-10 shadow-lg transition-transform duration-300 transform translate-x-0">
          <div className="p-6 flex flex-col h-full">
            ...
            <button
              className="mt-6 bg-green-500 hover:bg-green-600 text-white  font-bold py-2 px-4 rounded-full"
              onClick={() => {
            ...
            <button
              onClick={toggleDrawer}
              className="mt-2 bg-gray-200 text-gray-700 font-bold py-2 px-4 rounded-full"
            >
              Close
            </button>
          </div>
